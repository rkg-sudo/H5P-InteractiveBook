...
class Summary extends H5P.EventDispatcher {
   ...
   * @return {HTMLDivElement}
   */
  createProgress(title, smallText, progressCounter, progressTotal, isAbsoluteValues = false, smallProgress, smallProgressTotal, flag) {
   ...
   */
  addBookProgress() {
    const chaptersCompleted = this.chapters.filter(chapter => chapter.completed).length;
    ...
    const box = this.createProgress(
      ...
      chaptersCompleted,
      totalChapters,
      false, // isAbsoluteValues
      chaptersCompleted, // smallProgress
      totalChapters, // smallProgressTotal
      "addBookProgress"
    );
    box.classList.add("h5p-interactive-book-summary-progress-container");
  ...
  addInteractionsProgress() {
    ...
    const interactionsCompleted = Math.max(totalInteractions - uncompletedInteractions, 0);
    const box = this.createProgress(
      ...
      totalInteractions,
      false, // isAbsoluteValues
      interactionsCompleted, // smallProgress
      totalInteractions, // smallProgressTotal
      "addInteractionsProgress"
    );
    box.classList.add("h5p-interactive-book-summary-progress-container");
